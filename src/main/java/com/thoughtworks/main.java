...
import com.thoughtworks.model.ParkingLot;
import com.thoughtworks.view.Cli;
...
public class main {
    ...
    private static Router initRouter (String currentPage, Request request) {
        ...
        router.registerRouter("main/1/*",new ErrorController(request,response));
        ...
        router.registerRouter("main/2/*",new ErrorController(request,response));
